...
//        return ApplicatinoApi.getInstance().getApplications()
        return listOf(
            Application("ID 1","App 1","url", "Desc1", version = "0.1.alpha"),
            Application("ID 2","App 2","url", "Desc2", version = "0.2.alpha"),
            Application("ID 3","App 3","url", "Desc3", version = "0.3.alpha"),
            Application("ID 4","App 4","url", "Desc4", version = "0.4.alpha"),
            Application("ID 5","App 5","url", "Desc5", version = "1.0.beta"),
            Application("ID 6","App 6","url", "Desc6", version = "1.1.beta"),
            Application("ID 7","App 7","url", "Desc7", version = "1.2.beta"),
            Application("ID 8","App 8","url", "Desc8", version = "1.3.beta"))
    }
